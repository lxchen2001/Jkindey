...
public class ActCheckNiaodanbaiUpdate extends ActBase {
    ...
    MCheckTypeNiaodanbai check_niaodanbai;
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        check_niaodanbai = (MCheckTypeNiaodanbai) this.getIntent().getSerializableExtra("check");

        time = check_niaodanbai.getList().get(0).getTime();
        niaoliang = check_niaodanbai.getList().get(0).getValue().toString();
        danbai = check_niaodanbai.getList().get(1).getValue().toString();
    ...
    private void doUpdate() {
        ...
        checkTypeNiaodanbai.update(ActCheckNiaodanbaiUpdate.this, "" + check_niaodanbai.getObjectId(), new UpdateListener() {
            @Override
    ...
    private void doDelete() {
        MCheckTypeNiaodanbai danbai = new MCheckTypeNiaodanbai();
        danbai.remove("author");
        danbai.delete(ActCheckNiaodanbaiUpdate.this, "" + check_niaodanbai.getObjectId(), new DeleteListener() {
            @Override
            public void onSuccess() {
